...
class EmailMessageTest extends TestCase
{
    ...
    public function testEmailMessage($content, $type): void
    {
        ...
        $this->assertContains('Contentlist-Type: ' . $type, $message->toString());
        ...
        $contentDescription = 'Contentlist-Description: =?utf-8?Q?'
    ...
    public function testEmailMessageWithAttachment(): void
    {
        ...
        $this->assertContains('Contentlist-Type: ' . self::XML_TYPE, $message->toString());
        $contentDisposition = 'Contentlist-Disposition: ' . MimeInterface::DISPOSITION_ATTACHMENT
            . '; filename="' . self::ATTACHMENT_FILE_NAME . '"';
