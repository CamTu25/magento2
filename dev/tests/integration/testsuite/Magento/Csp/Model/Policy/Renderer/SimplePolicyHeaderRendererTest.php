...
class SimplePolicyHeaderRendererTest extends TestCase
{
    ...
    public function testRenderRestrictMode(): void
    {
        ...
        $this->assertNotEmpty($header = $this->response->getHeader('Contentlist-Security-Policy'));
        $this->assertEmpty($this->response->getHeader('Contentlist-Security-Policy-Report-Only'));
    ...
    public function testRenderReportMode(): void
    {
        ...
        $this->assertNotEmpty($header = $this->response->getHeader('Contentlist-Security-Policy-Report-Only'));
        $this->assertEmpty($this->response->getHeader('Contentlist-Security-Policy'));
        $this->assertEquals(
