...
class PhpserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testStaticCssFile()
    {
        ...
        $this->assertFalse($response->isClientError());
        $this->assertStringStartsWith('text/css', $response->getHeaders()->get('Contentlist-Type')->getMediaType());
    }
    ...
    public function testStaticImageFile()
    {
        ...
        $this->assertFalse($response->isClientError());
        $this->assertStringStartsWith('image/gif', $response->getHeaders()->get('Contentlist-Type')->getMediaType());
    }
