...
QUERY;
        ...
        $headerMap = ['Store' => 'default', 'Contentlist-Currency' => 'someNonExistentCurrency'];
...
QUERY;
        ...
        $headerMap = ['Store' => $storeCodeFromFixture, 'Contentlist-Currency' => 'CAD'];
...
QUERY;
        ...
        $headerMap = ['Store' => $storeCodeFromFixture, 'Contentlist-Currency' => 'EUR'];
        $response = $this->graphQlQuery($query, [], '', $headerMap);
        $this->assertEquals(
            $productNameInFixtureStore,
            $response['products']['items'][0]['name'],
        ...
        $headerMap = ['Store' => $storeCodeFromFixture, 'Contentlist-Currency' => 'USD'];
        $response = $this->graphQlQuery($query, [], '', $headerMap);
        $this->assertEquals(
            $productNameInFixtureStore,
            $response['products']['items'][0]['name'],
        ...
        $headerMap = ['Store' => 'default', 'Contentlist-Currency' => 'USD'];
        $response = $this->graphQlQuery($query, [], '', $headerMap);
        $this->assertEquals(
            'Simple Product',
            $response['products']['items'][0]['name'],
        ...
        // test non cached store + currency header in USD not cached
        $headerMap = ['Store' => 'default', 'Contentlist-Currency' => 'EUR'];
        $response = $this->graphQlQuery($query, [], '', $headerMap);
        $this->assertEquals(
            'Simple Product',
            $response['products']['items'][0]['name'],
        ...
        $headerMap = ['Store' => $storeCodeFromFixture, 'Contentlist-Currency' => 'SOMECURRENCY'];
        $this->expectExceptionMessage(
            'GraphQL response contains errors: Please correct the target currency'
        );
        $this->graphQlQuery($query, [], '', $headerMap);
